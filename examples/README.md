...
# 运行观澜平台示例
python examples/03.guanlan/0301.自制窗口演示.py
python examples/03.guanlan/0309.AI服务演示.py
```
...
| 文件                    | 说明                                  | 依赖               |
| ----------------------- | ------------------------------------- | ------------------ |
| 0301.自制窗口演示.py    | GuanlanWindow 自定义窗口、主题切换    | qfluentwidgets     |
| 0302.期货代码转换.py    | 期货合约代码转换工具                  | -                  |
| 0303.通用工具函数演示.py | 日期时间、字符串处理等工具函数        | -                  |
| 0304.交易时段判断演示.py | 交易时间段判断、节假日处理            | -                  |
| 0305.日志工具演示.py    | 观澜日志系统封装                      | -                  |
| 0306.系统工具演示.py    | 系统信息获取、进程管理                | -                  |
| 0307.Redis工具演示.py   | Redis 工具类封装                      | redis              |
| 0308.音频播放演示.py    | 音频播放功能                          | -                  |
| 0309.AI服务演示.py      | AI 服务配置、多模型切换、流式对话     | openai             |
